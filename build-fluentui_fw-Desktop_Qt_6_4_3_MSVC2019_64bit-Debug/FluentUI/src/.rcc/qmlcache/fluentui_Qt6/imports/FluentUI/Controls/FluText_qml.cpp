...
0x58,0x6,0x0,0x0,0x33,0x65,0x63,0x35,
...
0x0,0x0,0x0,0x0,0xc2,0x8e,0x27,0xc5,
0x1f,0xdf,0xa6,0x51,0x20,0x8a,0x31,0xf9,
0xfc,0x4a,0x88,0xf,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x2e,0x3,0x3c,0x4,0x50,0x6,0x2e,0x5,
0x3c,0x6,0x4c,0x4,0x2e,0x7,0x3c,0x8,
...
aotContext->initGetObjectLookup(4, r2_1, QMetaType::fromType<bool>());
if (aotContext->engine->hasError())
    return int();
}
// generate_JumpFalse
...
;
// generate_GetLookup
while (!aotContext->getEnumLookup(6, &r2_3)) {
...
label_0:;
// generate_GetLookup
while (!aotContext->getEnumLookup(8, &r2_3)) {
